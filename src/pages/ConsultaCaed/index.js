...
function ConsultaCaed() {
  ...
  return (
    <div style={{margin: '30px'  }}>
      <Card border="info">  
        <Card.Header style={{ background: '#267987', color:'#ffffff', height:'2.5rem'}}><h5>Consulta Caed</h5></Card.Header>
        <Card.Body>
          <Form>
            <Form.Group as={Row} className="mb-3">
              <Form.Label column sm="3" for= "chkRecuperacao"><b>Recuperação Continuada: </b></Form.Label>
              <Col sm="1">
                <Form.Switch style={{width: '60px', height: '60px'}} name="chkRecuperacao" id="chkRecuperacao" type="checkbox" checked={recuperacao} onChange={(e) => setRecuperacao(e.target.checked)} />
              </Col>            
            </Form.Group>        
            <Form.Group as={Row} className="mb-3">
